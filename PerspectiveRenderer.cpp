...
void PerspectiveRenderer::HandleInput() {
...
void PerspectiveRenderer::MainLoop()
{
	...
	int screen_quad_shader = CreateShaderFromFiles("v_screen_quad.glsl", "f_screen_quad.glsl");
	Mesh screen_quad_mesh(screen_quad_vertices, 4, screen_quad_indices, 6, GL_DYNAMIC_DRAW);
